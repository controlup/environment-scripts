...
if($VerbosDebug){Write-CULog -Msg "Disconnected:`n $($global:eucDisconnected)" -ShowConsole -Type W}
else{Write-CULog -Msg "Disconnected:`n $($global:eucDisconnected)" -Type W}
